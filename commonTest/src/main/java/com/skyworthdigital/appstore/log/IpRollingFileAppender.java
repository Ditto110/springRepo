 ...
 */
package com.skyworthdigital.appstore.log;
...
import com.skyworthdigital.appstore.utils.IpUtil;
...
public final class IpRollingFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
        ...
        public IpRollingFileAppender build() {
            ...
            fileName = fileName.replaceAll("nodeIp", "node" + IpUtil.getIpSuffix());
            filePattern = filePattern.replaceAll("nodeIp", "node" + IpUtil.getIpSuffix());
