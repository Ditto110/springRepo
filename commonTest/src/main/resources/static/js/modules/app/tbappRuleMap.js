$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '应用名称', name: 'name', index: 'name', width: 120 }, 			
			...
			{ label: '操作', name: 'id', index: 'id', width: 120,formatter:function(cellValue,options,rowObject){  
                ...
                return "<a  class='btn btn-primary btn-xs' btnPermission='tbappRuleMap:update' onclick='vm.editApp("+rowObject.id+",\""+rowObject.name+"\");'>编辑机型</a>";
			} }
        ],
		viewrecords: true,
        height: 385,
