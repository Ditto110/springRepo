        ...
        colModel: [
            ...
            { label: '操作', name: 'opt', width:60,
                formatter: function (value, grid, rows, state) {
                    return '<a class="btn btn-default" btnPermission="ttcustomer:update" onclick="edit('+ rows.id +')">修改</a>'
                        + '&nbsp;&nbsp;'
                        + '<a class="btn btn-default" btnPermission="ttcustomer:del" onclick="del('+ rows.id +')">删除</a>';
                }
            }
        ],
		viewrecords: true,
