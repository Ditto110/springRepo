		    ...
		    $("#appJqGrid").jqGrid({
		        ...
		        colModel: [			
					...
					{ label: '操作', name: 'id', index: 'id', width: 30,formatter: function(cellValue,options,rowObject){
						var actionHtml = "<a class='btn btn-primary btn-xs' btnPermission='appCommon:add' onclick='add("+rowObject.id+");'>添加</a>";
						return actionHtml;
			        } }		
		        ],
				viewrecords: true,
		        ...
		        gridComplete:function(){
		        	//隐藏grid垂直滚动条
		        	$("#appJqGrid").closest(".ui-jqgrid-bdiv").css({ "overflow-y" : "scroll" }); 
		        	//刷新按钮权限
			...
			<div class="col-md-4">\
				<div class="form-group">\
						...
						<div class="input-group">\
							...
							<a class="btn btn-primary" btnPermission="appCommon:add:batch" onclick="addBatch();"><i class="fa fa-plus"></i>&nbsp;批量新增</a>\
					    </div>\
				</div>\
				</div>\
			</div>\
