...
$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			{ label: '版本ID', name: 'appVersionId', index: 'appversionid', width: 30, key: true },
			...
			{ label: '操作', name: 'id', index: 'id', width: 40,formatter: function(cellValue,options,rowObject){
				debugger
				var actionHtml = "<a class='btn btn-primary btn-xs' onclick='vm.updateOldApp("+rowObject.id+","+rowObject.appVersionId+");'>&nbsp;修改</a>&nbsp;&nbsp;" +
